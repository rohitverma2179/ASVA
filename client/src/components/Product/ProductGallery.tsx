...
export const ProductGallery: React.FC<ProductGalleryProps> = ({ image, images: galleryImages }) => {
    ...
    return (
        <div className="flex gap-4 md:gap-6 h-[400px] md:h-[500px] lg:h-[600px]">
            ...
            <div className="flex-1 bg-white  relative flex items-center justify-center p-0 md:p-0 ">
                <img src={displayImages[activeImage]} alt="Product Main" className="h-full w-auto object-contain max-h-full" />
